...
class EnhancedHighlightExtractorV3:
    """
    Enhanced highlight extractor v3 with proper text collation.
    
    This version fixes the text mixing issue by:
    1. Preserving the original page-based grouping logic
    2. Properly collating text fragments from each .rm file
    3. Applying OCR corrections to the properly grouped text
    4. NOT replacing text with potentially wrong EPUB matches
    """
    
    def __init__(self, db_connection=None):
        self.processor_type = "enhanced_highlight_extractor_v3"
...
def process_directory_v3(directory_path: str, db_manager=None) -> Dict[str, int]:
    """
